...
** NOTE **
Currently compiling with CMake in Linux and Windows 7.
...
Setup CMake:
	...
	4. Set the source code to the directory where CMakeLists.txt is located, which is the AC folder.
	
	5. Set the build directory to AC\build.
	...
	9. Open up a command prompt and navigate to the AC\build folder. To build the project and create the ACGUI.jar type:
		make
	...
	Note: After the initial setup with CMake(cmake-gui), CMake can be run from the command prompt. To do this:
		...
		2. Navigate to AC\build.
		
		3. Type:
			cmake -G "Unix Makefiles" ..
			
		4. Once this is done, you can build the project and create the ACGUI.jar by typing:
			make
